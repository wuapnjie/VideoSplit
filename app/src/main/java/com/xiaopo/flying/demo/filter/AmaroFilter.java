 ...
 * @author wupanjie
 */
public class AmaroFilter extends AbstractShaderFilter {
  ...
  public AmaroFilter(Context context) {
    blowout = BitmapFactory.decodeResource(context.getResources(), R.drawable.blackboard_1024);
    overlay = BitmapFactory.decodeResource(context.getResources(), R.drawable.overlay_map);
    map = BitmapFactory.decodeResource(context.getResources(), R.drawable.amaro_map);
  }
  ...
  public void prepareTexture() {
    blowoutTextureId = loadTexture(blowout, NO_TEXTURE, false);
    overlayTextureId = loadTexture(overlay, NO_TEXTURE, false);
    mapTextureId = loadTexture(map, NO_TEXTURE, false);
  }
